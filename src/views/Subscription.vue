  ...
  <div>
    ...
    <div class="p-4 space-y-6">
      ...
      <Card>
        ...
        <div class="space-y-4">
          <ProgressBar
            :value="usageStats.currentUsage.databases"
          ...
          <ProgressBar
            :value="usageStats.currentUsage.tables"
          ...
          <ProgressBar
            :value="usageStats.currentUsage.records"
          ...
          <ProgressBar
            :value="usageStats.currentUsage.storage"
            :max="usageStats.limits.storage"
      ...
      <div>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <button
              v-if="plan.id !== authStore.subscriptionPlan"
          ...
          <table class="w-full text-sm">
            <thead>
              <tr class="border-b border-gray-200 dark:border-gray-700">
                ...
                <th v-for="plan in plans" :key="plan.id" class="text-center py-2 font-medium text-gray-900 dark:text-white capitalize">
                  {{ plan.name }}
                </th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <tr v-for="feature in comparisonFeatures" :key="feature.name">
                ...
                <td v-for="plan in plans" :key="plan.id" class="text-center py-3">
                  <component
                    :is="getFeatureIcon(feature.values[plan.id])"
                    :class="getFeatureIconClass(feature.values[plan.id])"
                    class="w-5 h-5 mx-auto"
                  />
                  <div v-if="typeof feature.values[plan.id] === 'string'" class="text-xs text-gray-500 dark:text-gray-400 mt-1">
